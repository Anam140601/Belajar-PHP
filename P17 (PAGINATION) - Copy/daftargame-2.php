	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="padding: 0px;">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <?php foreach ($gam as $row1) : ?>
              <marquee onmouseover="this.stop()" onmouseout="this.start()" ><a href="downloadgame-2.php?id=<?= $row1["id"]; ?>" target="blank"><?= $row1["Nama"] ?></a></marquee>
            <?php endforeach;?>
      </div>
	...
	<div class="table-responsive">
		<table class="table table-bordered table-striped table-hover" border="1" cellpadding="10" cellspacing="0">
			...
			<tr>
				...
				<td><a href="downloadgame-2.php?id=<?= $row["id"]; ?>"><?= $row["Nama"] ?></a></td>
			</tr>
			<?php $i++; ?>
			<?php endforeach ; ?>
