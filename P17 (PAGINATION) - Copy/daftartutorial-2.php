...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="padding: 0px;">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <?php foreach ($tut as $row1) : ?>
              <marquee onmouseover="this.stop()" onmouseout="this.start()" ><a href="downloadtutorial-2.php?id=<?= $row1["id"]; ?>" target="blank"><?= $row1["Judul"] ?></a></marquee>
            <?php endforeach;?>
      </div>
	...
	<div class="table-responsive">
		<table class="table table-bordered table-striped table-hover" border="1" cellpadding="10" cellspacing="0">
			...
			<tr>
				<td><?= $i ?></td>
				<td style="text-align: center;"><img src="img/<?= $row["Gambar"]; ?>" height="50" width="50"></td>
				<td><a href="downloadtutorial-2.php?id=<?= $row["id"]; ?>"> <?= $row["Judul"] ?></a></td>
			</tr>
			<?php $i++; ?>
			<?php endforeach ; ?>
