...
$anime = query("SELECT*FROM anime ORDER BY id DESC LIMIT $awaldata, $jumlahdataperhalaman");
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
       <a class="navbar-brand">Anigato</a>
	...
	<h1 style="text-align: center; color: red;">Daftar anime</h1>
	...
	<div class="table-responsive">
		<table class="table table-bordered table-striped table-hover" border="1" cellpadding="10" cellspacing="0">
			...
			<tr>
				<td><?= $i ?></td>
				<td>
					<span class="badge badge-info"><a href="update.php?id=<?= $row["id"]; ?>">Update</a></span>
					<span class="badge badge-danger"><a href="delete.php?id=<?= $row["id"]; ?>" onclick="return confirm('Anda yakin akan menghapus datanya??');">Delete</a></span>
					
				</td>

				<td style="text-align: center;"><img src="img/<?= $row["Gambar"]; ?>" width="50" height="50"></td>
				<td><a href="download.php?id=<?= $row["id"]; ?>"><?= $row["Nama"] ?></a></td>
			</tr>
			<?php $i++; ?>
			<?php endforeach ; ?>
...
<br><br>
	<!-- navigasi -->
	<a class="btn btn-success btn-sm , tambah" href="tambah.php">Tambah data anime</a>
