...
<div class="jumbotron jumbotron-fluid">
  <div class="container-fluid">
    ...
    <h1 style="top: 50%;">Download Anime <?= $anim["Nama"] ?></h1>
      ...
      <p>
        <p ><?= $anim["Nama"] ?></p>
        <img src="img/<?= $anim["Gambar"]; ?>" width="30%" alt="Responsive image"><br>

        <strong>Sinopsis : </strong><br>
        <p><?= nl2br(htmlspecialchars_decode($anim['Sinopsis'])) ?></p><br>

        <strong>Tahun Rilis : </strong><br>
        <p><?= $anim['Tahun_Rilis'] ?></p><br>
