    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="padding: 0px;">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <?php foreach ($ani as $row1) : ?>
              <marquee onmouseover="this.stop()" onmouseout="this.start()" ><a href="download-2.php?id=<?= $row1["id"]; ?>" target="blank"><?= $row1["Nama"] ?></a></marquee>
            <?php endforeach;?>

      </div>
      <a type="button" class="btn btn-info btn-sm " href="login.php">Login!</a>
      <a type="button" class="btn btn-success btn-sm " href="registrasi.php">Register!</a>
    </nav>
    ...
    <table class="table table-bordered table-striped table-hover" border="0" cellpadding="10" cellspacing="0">
      ...
      <?php foreach ($anime as $row) : ?>
        ...
        <tr>
          ...
          <td class="col-11"><p><a style="color: green;" href="download-2.php?id=<?= $row["id"]; ?>"><?= $row["Nama"] ?></p></td>
...
<br>
  ...
  <div class="table-responsive">
    <table class="table table-bordered table-striped table-hover" border="0" cellpadding="10" cellspacing="0">
      ...
      <tr>
        <td><?= $i ?></td>
        <td class="col-1"  style="text-align: center;"><p><img src="img/<?= $row["Gambar"]; ?>"  width="50" height="50"></td></p>
        <td class="col-11"><p><a style="color: lightskyblue;" href="downloadgame-2.php?id=<?= $row["id"]; ?>"><?= $row["Nama"] ?></p></td>
      </tr>
      <?php $i++; ?>
      <?php endforeach ; ?>
  ...
  <div class="table-responsive">
    <table class="table table-bordered table-striped table-hover" border="0" cellpadding="10" cellspacing="0">
      ...
      <tr>
        <td><?= $i ?></td>
        <td class="col-1"  style="text-align: center;"><p><img src="img/<?= $row["Gambar"]; ?>"  width="50" height="50"></td></p>
        <td class="col-11"><p><a style="color: red;" href="downloadtutorial-2.php?id=<?= $row["id"]; ?>"><?= $row["Judul"] ?></p></td>
      </tr>
      <?php $i++; ?>
      <?php endforeach ; ?>
